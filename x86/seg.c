...
static void setseg(ulong *gdt, int type, u32 base, u32 limit, int dpl, int l) {
...
static void settssseg(ulong *gdt, int type, u64 base, u32 limit, int dpl) {
...
static inline void loadgdt(const ulong *gdt, ulong gdtsize) {
  volatile u16 t[5];
