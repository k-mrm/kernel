...
static void x86amdinit(X86cpu *cpu) {
  char procstr[48] = {0};

  cpuid(CPUID_EXT2, (u32 *)procstr, (u32 *)(procstr + 4), (u32 *)(procstr + 8),
        (u32 *)(procstr + 12));
  cpuid(CPUID_EXT3, (u32 *)(procstr + 16), (u32 *)(procstr + 20),
        (u32 *)(procstr + 24), (u32 *)(procstr + 28));
  cpuid(CPUID_EXT4, (u32 *)(procstr + 32), (u32 *)(procstr + 36),
        (u32 *)(procstr + 40), (u32 *)(procstr + 44));

  log("Processor: %s\n", procstr);
}

static X86cpu *findx86cpu(char *vendor) {
  const char **id;
...
void x86cpuinit(void) {
  ...
  cpuid(CPUID_0, &a, (u32 *)cpuvendor, (u32 *)(cpuvendor + 8),
        (u32 *)(cpuvendor + 4));
  log("CPU Vendor: %s\n", cpuvendor);
