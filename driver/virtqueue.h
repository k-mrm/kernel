...
VirtQ *newvirtq(VirtioDevice *dev, int qsel, void (*intrhandler)(VirtQ *));

static inline int vqenqueuein(VirtQ *vq, SBuf *s, int ns, void *cookie) {
  return vqenqueue(vq, s, ns, cookie, true);
}

static inline int vqenqueueout(VirtQ *vq, SBuf *s, int ns, void *cookie) {
